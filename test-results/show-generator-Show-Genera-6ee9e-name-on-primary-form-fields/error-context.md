...
- Name: show-generator.spec.ts >> Show Generator >> should have id and name on primary form fields
- Location: e2e\show-generator.spec.ts:30:3
...
Locator:  locator('#show-duration')
Expected: visible
Received: undefined

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('#show-duration')
