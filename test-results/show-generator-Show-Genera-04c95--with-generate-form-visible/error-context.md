...
- Name: show-generator.spec.ts >> Show Generator >> should load home page with generate form visible
- Location: e2e\show-generator.spec.ts:24:3
...
Locator:  locator('#show-topic')
Expected: visible
Received: undefined

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('#show-topic')
...
- generic [ref=e5]:
  - generic [ref=e6]:
    ...
    - form "Produce radio show" [ref=e11]:
      - generic [ref=e14]:
